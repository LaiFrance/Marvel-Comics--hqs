...
export class AvengersService {
    ...
    URL_API_WANDA = `https://gateway.marvel.com:443/v1/public/characters?name=wanda&nameStartsWith=wanda&orderBy=name&limit=100&apikey=${this.PUBLIC_KEY}&hash=${this.HASH}`;;
